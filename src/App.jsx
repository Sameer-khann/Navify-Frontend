        ...
        <div className="min-h-screen bg-[rgba(27,27,27,1)] p-6 md:p-10 lg:p-16">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    The Delhi Jal Board (DJB) manages the supply of drinking
                    water and the collection, treatment, and disposal of sewage
                    in the capital.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    The Employees' Provident Fund Organisation (EPFO) manages
                    provident fund, pension, and insurance schemes for India's
                    workforce.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    ...
                    provides online services for vehicle registration, driving
                    licenses, & transport permits across India.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              <div className="flex">
                <div className="mr-4">
                  <div className="bg-gray-200 p-2 rounded-lg w-16 h-16 flex items-center justify-center">
                    <svg
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Add yourself</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            <nav>
              <ul className="space-y-3">
                ...
                <li><a href="#" className="hover:text-gray-300">Repository</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="flex flex-col">
            <nav>
              <ul className="space-y-3">
                ...
                <li><a href="#" className="hover:text-gray-300">Security & Privacy</a></li>
